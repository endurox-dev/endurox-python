...
Other option is to following the installation process of the Enduro/X for Python
by using source package and "python3 ./setup.py install --user", which does
not generate above error.
